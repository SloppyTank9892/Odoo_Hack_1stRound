...
export function DesktopSidebar({ onOpenCreateTrip }: DesktopSidebarProps) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-white border-r border-[#E7E2D8] h-screen h-[100dvh] sticky top-0 shrink-0 select-none z-30 overflow-hidden">
      {/* Brand Header */}
      <div className="p-6 pb-4 border-b border-[#E7E2D8]/60 flex items-center justify-between shrink-0">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-3 py-4 space-y-4">
        ...
        {activeTrip && (
          <div className="p-3.5 bg-[#FAF9F5] rounded-2xl border border-[#E7E2D8] text-xs">
