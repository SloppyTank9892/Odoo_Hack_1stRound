    ...
    return (
      <div className="min-h-screen bg-[#F7F6F2] flex flex-col text-[#181818]">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <Card className="text-center py-16 px-6 max-w-md mx-auto bg-white shadow-xs border-[#E7E2D8]">
  ...
  if (!trip.isPublic && !isOwner) {
    return (
      <div className="min-h-screen bg-[#F7F6F2] flex flex-col text-[#181818]">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <Card className="text-center py-16 px-6 max-w-md mx-auto bg-white shadow-xs border-[#E7E2D8]">
            <div className="w-14 h-14 rounded-2xl bg-[#FEF7EC] text-[#B86E00] border border-[#FCD89C] flex items-center justify-center mx-auto mb-4 text-2xl">
              🔒
            </div>
            <h2 className="text-xl font-bold font-editorial text-[#181818] mb-2">
              This Journey is Private
            </h2>
            <p className="text-xs text-[#6B655E] mb-6 leading-relaxed">
